...
module Compile : sig
  ...
  module Dep : sig
    ...
    val write : B0_memo.t -> Filepath.t -> o:Filepath.t -> unit
  ...
  module Writes : sig
    ...
    val write :
      B0_memo.t -> Filepath.t -> to_odoc:Filepath.t -> o:Filepath.t -> unit
    (** [write m cobj ~to_odoc ~o] writes the files written by a compilation
        of [cobj] to [to_odoc] to [o]. *)

    val read : B0_memo.t -> Filepath.t -> Filepath.t list Fut.t
  ...
  val cmd :
    ...
    odoc_deps:Filepath.t list -> writes:Filepath.t list -> pkg:string ->
    Filepath.t -> o:Filepath.t -> unit
  ...
  val to_odoc :
    ...
    odoc_deps:B0_std.Filepath.t list -> B0_std.Filepath.t ->
...
module Html : sig
  ...
  module Dep : sig
    ...
    val write :
      B0_memo.t -> odoc_files:Filepath.t list -> Filepath.t -> o:Filepath.t ->
      unit
  ...
  module Writes : sig
    ...
    val write :
      B0_memo.t -> odoc_deps:Filepath.t list -> Filepath.t ->
      to_dir:Filepath.t -> o:Filepath.t -> unit
  ...
  val cmd :
    ...
    odoc_deps:Filepath.t list -> writes:Filepath.t list -> Filepath.t ->
    to_dir:Filepath.t -> unit
  ...
  val write :
    B0_memo.t -> ?theme_uri:string -> html_dir:B0_std.Filepath.t ->
    odoc_deps:B0_std.Filepath.t list -> B0_std.Filepath.t -> unit
...
module Html_fragment : sig
  val cmd :
    B0_memo.t -> odoc_deps:Filepath.t list -> Filepath.t -> o:Filepath.t -> unit
...
module Support_files : sig
  ...
  module Writes : sig
    ...
    val write :
      ?without_theme:bool -> B0_memo.t -> to_dir:Filepath.t -> o:Filepath.t ->
      unit
  ...
  val cmd :
    ?without_theme:bool -> B0_memo.t -> writes:Filepath.t list ->
    to_dir:Filepath.t -> unit
  ...
  val write :
    B0_memo.t -> without_theme:bool -> html_dir:Filepath.t ->
    build_dir:Filepath.t -> unit
...
module Theme : sig
  ...
  val write : B0_memo.t -> t -> to_dir:Filepath.t -> unit
