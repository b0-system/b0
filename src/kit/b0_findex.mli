...
val of_dirs :
  ?prune_dir:(Unix.stats -> string -> Filepath.t -> bool) ->
  dotfiles:bool -> follow_symlinks:bool ->
  Filepath.t list -> (t, string) result
