...
module Fpath = struct
  ...
  let err_invalid_seg s = Fmt.str "%a: Invalid path segment" Fmt.OCaml.string s
  let err_start s = Fmt.error "%a: Not a path" Fmt.OCaml.string s
  let err_null s = Fmt.error "%a: Not a path: has null bytes" Fmt.OCaml.string s
  let err_empty s = Fmt.error "%a: Not a path: is empty" Fmt.OCaml.string s
